...
public class Main {
    public static void main(String[] args) {
        Customer customer = new Customer(42, "Nova Trading", 8 );
        CustomerState customerState = new CustomerState(true, false, 5000);
        ...
        Shipment shipment = new Shipment("GF-2026-001", customer, customerState);
        ShipmentInfo shipmentInfo= new ShipmentInfo(origin, destination, ship, LocalDate.of(2026, 12, 12));
